					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between ml-5" style="width: 150px;">
					  ...
					  {{csrf_field()}}
					      <div class="card-body pt-0">	
									...
									<div class="form-group">
										...
										<textarea  class="form-control" name="description" id="description" cols="10" rows="5" placeholder="ادخل وصف للقسم"></textarea>
									</div>
                            ...
                            <div class="modal-content modal-content-demo">
                                ...
                                <form action="sections/destroy" method="post">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p> سوف يتم حذف كل المنتجات الخاصه بالقسم دا ايضاً</p><br>
                                        <input type="hidden" name="id" id="id" value="">
