				...
				<div class="row row-sm">
					...
					<div class="col-xl-12">
						<div class="card mg-b-20">
							...
							<a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-newspaper" data-toggle="modal" href="#modaldemo8"> + إضافه منتج </a>
									...
									<table id="example" class="table key-buttons text-md-nowrap text-center" data-page-length="50">
										...
										<?php $count = 1?>
											...
											<tr>
												...
												<td><a class="modal-effect btn btn-sm btn-success" 
					  ...
					  {{csrf_field()}}
					      <div class="card-body pt-0">	
									...
									<div class="form-group">
										...
										<textarea  class="form-control" name="description" id="description" cols="10" rows="5" placeholder="ادخل ملاحظات للمنتج"></textarea>
									</div>
									<div class="form-group">
